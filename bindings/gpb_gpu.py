...
def gpb(image):
    ...
    code="""
         ...
         """
    inline(code,['padded_image','textons','width', 'height','borders','orientations'], type_converters=converters.blitz, compiler = 'gcc',headers=['"'+os.path.join(cur_dir, 'gpb.h')+'"'],include_dirs=['.'],libraries=libraries,library_dirs=library_dirs,runtime_library_dirs=library_dirs,verbose=0,force=1)
